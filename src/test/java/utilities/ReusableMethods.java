...
public class ReusableMethods {
    ...
    public static void  ekranKaydirma(int xBaslangicKoor,int yBaslangicKoor,int beklemeSuresi,int xBitisKoor, int yBitisKoor) {
        TouchAction action = new TouchAction<>(Driver.getAndroidDriver());
        action.press(PointOption.point(xBaslangicKoor,yBaslangicKoor))
                .waitAction(WaitOptions.waitOptions(Duration.ofMillis(beklemeSuresi)))
                .moveTo(PointOption.point(xBitisKoor,yBitisKoor))
                .release().perform();
